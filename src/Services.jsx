...
import { FaCode, FaGlobe, FaMicrochip, FaPalette, FaChartLine, FaUsers } from 'react-icons/fa';
...
const Services = () => {
  ...
  const services = [
    ...
    },
    {
      ...
      description: 'Intelligent agents, automation, and predictive analytics',
  ...
  return (
    <div className="min-h-screen bg-neutral-900 text-white antialiased">
      {/* NAV */}
      <header className={`sticky top-0 z-40 backdrop-blur border-b ${theme === 'dark' ? 'bg-black/40 border-white/5' : 'bg-white/40 border-gray-200'}`}>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <motion.p
            ...
            className={`text-xl max-w-2xl mx-auto ${theme === 'dark' ? 'text-white/70' : 'text-gray-600'}`}
          >
