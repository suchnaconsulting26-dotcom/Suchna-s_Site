...
const Work = () => {
  ...
  const projects = [
    {
      title: 'Bhagawati Timber\'s',
      description: 'A comprehensive website for Bhagawati Timber\'s showcasing their timber products, services, and company information with modern design and responsive layout.',
      image: '/Bhagawati_Timbet.jpg',
      technologies: ['HTML5', 'CSS', 'JavaScript'],
      liveUrl: 'https://bhagawatitimbers.com',
      githubUrl: '#',
      category: 'Web Development'
    },
    {
      title: 'Andani Polymers',
      description: 'Professional website for Adani Polymers featuring their polymer products, manufacturing capabilities, and industry expertise with clean, corporate design.',
      image: '/Andani.jpeg',
      technologies: ['HTML5', 'CSS3', 'JavaScript', 'PHP'],
      liveUrl: 'https://suchnaconsulting26-dotcom.github.io/Adani_Polymers/',
      githubUrl: '#',
      category: 'Web Development'
    },
    {
      title: 'Bhagawati PaperBox',
      description: 'Informational website for Bhagawati PaperBox displaying their packaging solutions, product catalog, and business services.  Clean Model Design.',
      image: '/Paper_box.jpeg',
      technologies: ["HTML5", "CSS3", "JavaScript"],
      liveUrl: 'https://bhagawatipaperbox.com',
      githubUrl: '#',
      category: 'Web Development'
    },
    {
    ...
    },
    {
      ...
      description: 'An intelligent health assistant application designed to help users track health metrics, manage appointments, and receive personalized health recommendations.',
      image: '/Health_Assistant.jpeg',
      technologies: ['React', 'Node.js', 'MongoDB', 'Express'],
      liveUrl: 'https://mrptl.github.io/MediAi/',
      githubUrl: '#',
      category: 'SaaS & ERP'
    },
    {
      title: 'Suchna CRM',
      description: 'A powerful Customer Relationship Management system designed to enhance customer interactions, track leads, and drive business growth.',
      image: '/Suchna_CRM.jpeg',
      technologies: ['React', 'Node.js', 'PostgreSQL', 'GraphQL'],
      liveUrl: 'https://suchnaconsulting26-dotcom.github.io/Suchna_CRM_Advanced/',
      githubUrl: '#',
      category: 'CRM'
    }
  ];
        ...
        <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              ...
              <div className={`text-xs -mt-1 ${theme === 'dark' ? 'text-white/60' : 'text-gray-500'}`}>Simple. Smart. Suchna.</div>
            </div>
          </Link>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {projects.map((project, index) => (
              <motion.div
                ...
                className="group"
              >
                <div className="bg-gray-800 border border-gray-700 rounded-xl overflow-hidden hover:border-teal-500 transition-all duration-300 hover:shadow-lg hover:shadow-teal-500/20">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.technologies.map((tech) => (
                        <span key={tech} className="px-2 py-1 bg-teal-500/20 text-teal-300 text-xs rounded">
                          {tech}
                        </span>
                      ))}
                    </div>
